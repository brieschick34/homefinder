...
class Configuration:
  ...
  def printConfigToSTDOUT(self):
    ...
    print("  -> Down Payment Precent: " + str(self.downPaymentPrecent))
    ...
    print("  -> Buy Down Rate: " + str(self.buyDownRate) + "\n")
  ...
  def writeConfigToFile(self, filename):
    ...
    f.write("  -> Loan Interest Rate: " + str(self.interestRate) + "\n")
    f.write("  -> PMI Precent: " + str(self.pmiPrecent) + "\n")
    f.write("  -> Loan Term Length (Before Extra Payments): " + str(self.initalTermLength) + "\n")
    f.write("  -> Property Tax Precent: " + str(self.propertyTaxRate*100) + "\n")
    f.write("  -> Closing Cost Precent: " + str(self.closingCostPrecent*100) + "\n")
    f.write("  -> Home Insurance Precent: " + str(self.insuranceRate*100) + "\n")
    ...
    f.write("Monthly Expenses: " + str(round(self.monthlyExpenses, 2)) + "\n")
    ...
    f.write("  -> Down Payment: " + str(self.downPayment) + "\n")
    f.write("  -> Buy Down Amount: " + str(self.buyDownAmount) + "\n")
    f.write("  -> Estimated Additional Closing Costs ( " + str(closingCostPrecent*100) + "% ): "  + str(self.closingCost) + "\n")
